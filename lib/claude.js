...
async function routeCommand(transcript, skillsContext, workflowsContext) {
  ...
  const tools = [
    ...
    },
    {
      ...
      description:
        ...
        '- web_search (target=query) — "search for X"\n' +
    ...
    },
    {
      name: 'look_at_screen',
      description:
        'Look at what is currently on the user\'s screen and ANSWER a question about it or ' +
        'summarize it — this READS the screen and replies with text (it does not click or ' +
        'type). Use for: "summarize this tab/page/article", "what does this say", "read this ' +
        'to me", "what am I looking at", "what\'s on my screen". Prefer this over run_goal ' +
        'whenever the user wants information ABOUT the screen rather than an action.',
      input_schema: {
        type: 'object',
  ...
  const system =
    ...
    'concrete multi-step GUI task, or reply otherwise (use reply for questions, chit-chat, or ' +
...
module.exports = { understandDemonstration, chat, planExecution, routeCommand, describeScreen };
