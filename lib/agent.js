          ...
          content: [
            {
              ...
              text:
                ...
                `FULLY accomplished: "${goal}"? If it is genuinely complete, reply with exactly ` +
                'the word DONE. If not — or if you were blocked — take the NEXT concrete action ' +
                'RIGHT NOW to finish it (try a different approach if something failed). Keep ' +
                'going until it is truly done.',
            },
            ...(shotBlock ? [shotBlock] : []),
          ],
        });
